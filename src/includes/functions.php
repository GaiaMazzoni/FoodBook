...
function print_post($username, $postId, $mysqli, $type){
    ...
    $result .= "<div class='icon'>
        <div class='icon'>
            <button class='like btn btn-primary' id='$username' value='$postId' style='background-color: #fccf00; border-color: #fccf00;'>
    ...
    $result .= "
        <div class='collapsible-tags-container'>
            <button class='tags-button' role='button' data-bs-toggle='collapse' data-bs-target='#tagsCollapse_$username$postId' aria-expanded='true' aria-controls='tagsCollapse_$username$postId'>
                Show Tags
            </button>
